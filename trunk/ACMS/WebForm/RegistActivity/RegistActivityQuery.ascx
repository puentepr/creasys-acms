<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistActivityQuery.ascx.cs"
    Inherits="WebForm_RegistActivity_RegistActivityQuery" %>
            ...
            <asp:Panel ID="Panel2" runat="server" GroupingText="查詢活動">
                <div class="SpaceDiv">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                        SelectMethod="RegistActivityQuery" TypeName="ACMS.BO.SelectorBO">
                        <SelectParameters>
