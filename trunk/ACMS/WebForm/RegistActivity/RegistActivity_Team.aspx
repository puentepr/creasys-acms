...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <table align="center">
                        <tr id="tr_showteam_fix1" runat="server">
                            ...
                            <td width="70%">
                                ...
                                <asp:RequiredFieldValidator ID="chk_txtteam_name" runat="server" 
                                    ControlToValidate="txtteam_name" Display="Dynamic" ErrorMessage="團隊名稱必填" 
                        ...
                        <tr id="tr_showteam_fix2" runat="server">
                            ...
                            <td>
                                ...
                                )<asp:RequiredFieldValidator ID="chk_text_people" runat="server" 
                                    ControlToValidate="txtext_people" Display="Dynamic" ErrorMessage="攜伴人數限制必填" 
                                    ValidationGroup="WizardNext"></asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="chk_text_people2" runat="server" 
                                    ControlToValidate="txtext_people" Display="Dynamic" ErrorMessage="攜伴人數限制必填數字" 
                                    Operator="DataTypeCheck" Type="Integer" ValidationGroup="WizardNext"></asp:CompareValidator>
                                <asp:RangeValidator ID="chk_text_people3" runat="server" 
                                    ControlToValidate="txtext_people" Display="Dynamic" ErrorMessage="攜伴人數必在限制範圍內" 
                                    Type="Integer" ValidationGroup="WizardNext"></asp:RangeValidator>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                <asp:Panel ID="PanelTeamMember" runat="server" GroupingText="團隊成員">
                    <asp:Panel ID="PanelTeamMenberInfoA" runat="server">
                        <div align="right">
                            ...
                            <uc2:OpenTeamMemberSelector ID="OpenTeamMemberSelector1" OnGetEmployeesClick="GetEmployees_Click" runat="server" />
                        </div>
                    </asp:Panel>
                    <asp:Panel ID="PanelTeamMenberInfoB" runat="server">
                        <TServerControl:TGridView ID="GridView_TemMember" runat="server" AllowHoverEffect="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnVOdelete" runat="server" CausesValidation="False" 
                                            onclick="lbtnVOdelete_Click" Text="刪除"></asp:LinkButton>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                        ...
                        <uc5:OpenTeamPersonInfo ID="OpenTeamPersonInfo1"  OnGetTeamPersonInfoClick="GetTeamPersonInfo_Click" runat="server" />
                    </asp:Panel>
                </asp:Panel>
            </asp:WizardStep>
    ...
    <asp:ValidationSummary ID="sum_person_info" runat="server" 
