...
<%@ Register Src="../OpenSmallEmployeeSelector.ascx" TagName="OpenSmallEmployeeSelector"
    TagPrefix="uc4" %>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:FormView ID="FormView_RegisterPersonInfo" runat="server" DataSourceID="ObjectDataSource_RegisterPersonInfo"
                                                ...
                                                <ItemTemplate>
                                                    部門:<asp:Label ID="dept_nameLabel" runat="server" Text='<%# Bind("C_DEPT_ABBR") %>' />
                                                    &nbsp; 工號:
                                        ...
                                        <td>
                                            ...
                                            <uc4:OpenSmallEmployeeSelector ID="OpenSmallEmployeeSelector1" runat="server" OnGetSmallEmployeesClick="GetSmallEmployees_Click" />
                                        </td>
                                    </tr>
                                </table>
