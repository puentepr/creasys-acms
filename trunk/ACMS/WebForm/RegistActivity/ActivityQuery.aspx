<%@ Page Title="" Language="C#" MasterPageFile="~/MyMasterPage.master" AutoEventWireup="true"
    CodeFile="ActivityQuery.aspx.cs" Inherits="WebForm_RegistActivity_ActivityQuery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <tr>
            <td colspan="2">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem>現行執行中活動查詢</asp:ListItem>
                    <asp:ListItem>歷史資料查詢</asp:ListItem>
                </asp:RadioButtonList>
            </td>
            <td>
    ...
    <TServerControl:TGridView ID="GridView1" runat="server" AllowHoverEffect="True" AllowHoverSelect="True"
        ...
        TotalRowCount="0" Width="100%" OnRowDataBound="GridView1_RowDataBound">
        <Columns>
            ...
            <asp:BoundField DataField="RegistCount" HeaderText="已報名人數" SortExpression="RegistCount">
                <ItemStyle HorizontalAlign="Right" />
            </asp:BoundField>
            <asp:TemplateField HeaderText="活動日期" SortExpression="activity_startdate">
                ...
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("activity_startdate") %>'></asp:TextBox>
                </EditItemTemplate>
            </asp:TemplateField>
