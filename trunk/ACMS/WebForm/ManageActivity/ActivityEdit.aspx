<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ActivityEdit.aspx.cs" Inherits="WebForm_ManageActivity_ActivityEdit" %>
            ...
            <table align="center">
                ...
                <tr>
                    <td>
                        活動日期</td>
                    <td>
                        <asp:TextBox ID="txtactivity_date" runat="server" 
                            Text='<%# Bind("activity_date") %>'></asp:TextBox>
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" 
                            TargetControlID="txtactivity_date">
                ...
                <tr>
                    <td>
                        活動人數上限</td>
                    <td>
                        <asp:TextBox ID="peoplelimit_countTextBox" runat="server" 
                            Text='<%# Bind("peoplelimit_count") %>' />
                    </td>
                </tr>
                <tr>
                    <td>
                        活動備取人數</td>
                    <td>
                        <asp:TextBox ID="peoplelimit2_countTextBox" runat="server" 
                            Text='<%# Bind("peoplelimit2_count") %>' />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" 
                            TargetControlID="txtcancelregist_deadline">
                        </ajaxToolkit:CalendarExtender>
                    </td>
                </tr>
                <tr>
