                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="chk_ddlorg_id" runat="server" 
                                        ControlToValidate="ddlorg_id" Display="Dynamic" ErrorMessage="活動主辦單位必填" 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="chk_txtactivity_name" runat="server" 
                                        ControlToValidate="txtactivity_name" Display="Dynamic" ErrorMessage="活動名稱必填" 
                                        ValidationGroup="WizardNext"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="chk_txtpeople_type" runat="server" 
                                        ControlToValidate="txtpeople_type" Display="Dynamic" ErrorMessage="活動對象必填" 
                                        ValidationGroup="WizardNext"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <uc3:DatetimePicker ID="txtactivity_startdate" DateTimeValue='<%# Bind("activity_startdate") %>'
                                        runat="server" EnableTheming="False" EnableViewState="True" RequiredErrorMessage="活動日期(起)必填" FormatErrorMessage="活動日期(起)格式不正確"
                            ...
                            <tr>
                                ...
                                <td>
                                    <uc3:DatetimePicker ID="txtactivity_enddate" runat="server" DateTimeValue='<%# Bind("activity_enddate") %>'
                                        EnableTheming="True" RequiredErrorMessage="活動日期(迄)必填" FormatErrorMessage="活動日期(迄)格式不正確" ValidationGroup="WizardNext" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr id="trteam_member_max" runat="server">
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="chk_txtteam_member_max" runat="server" 
                                        Display="Dynamic" ErrorMessage="每隊人數上限必填" ValidationGroup="WizardNext" 
                                    ...
                                    <asp:CompareValidator ID="chk_txtteam_member_max2" runat="server" 
                                        ControlToValidate="txtteam_member_max" ErrorMessage="每隊人數上限必填數字" 
                            ...
                            <tr id="trteam_member_min" runat="server">
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="chk_txtteam_member_min" runat="server" 
                                        Display="Dynamic" ErrorMessage="每隊人數下限必填" ValidationGroup="WizardNext" 
                                    ...
                                    <asp:CompareValidator ID="chk_txtteam_member_min2" runat="server" 
                                        ControlToValidate="txtteam_member_min" ErrorMessage="每隊人數下限必填數字" 
                                        Operator="DataTypeCheck" Type="Integer" ValidationGroup="WizardNext" 
                                        Display="Dynamic"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="chk_txtregist_deadline" runat="server" 
                                        ControlToValidate="txtregist_deadline" ErrorMessage="報名截止日必填" 
                                    ...
                                    <asp:CompareValidator ID="chk_txtregist_deadline2" runat="server" 
                                        ControlToValidate="txtregist_deadline" ErrorMessage="報名截止日格式不正確" 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="chk_txtcancelregist_deadline" runat="server" 
                                        ControlToValidate="txtcancelregist_deadline" ErrorMessage="取消報名截止日必填" 
                                        Display="Dynamic" ValidationGroup="WizardNext"></asp:RequiredFieldValidator>
                                    <asp:CompareValidator ID="chk_txtcancelregist_deadline2" runat="server" 
                                        ControlToValidate="txtcancelregist_deadline" ErrorMessage="取消報名截止日格式不正確" 
                                        Operator="DataTypeCheck" Type="Date" Display="Dynamic" 
                                        ValidationGroup="WizardNext"></asp:CompareValidator>
                                </td>
                            </tr>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbtnFileDownload" runat="server" 
                                                        CommandArgument='<%# Eval("path") %>' onclick="lbtnFileDownload_Click">下載</asp:LinkButton>
                                                </ItemTemplate>
                ...
                <asp:FormView ID="FormView2" runat="server" 
                    ...
                    <ItemTemplate>
                        <asp:Panel ID="PanelCustomFieldA1" runat="server" GroupingText="個人固定欄位">
                            <div>
                                <TServerControl:TCheckBoxYN ID="chkis_showperson_fix1" runat="server" Text="身分證字號" YesNo='<%# Bind("is_showperson_fix1") %>' />
                                <asp:UpdatePanel ID="UpdatePanelA" runat="server">
                                    <ContentTemplate>
                                       <TServerControl:TCheckBoxYN ID="chkis_showperson_fix2" runat="server" 
                                            Text="攜伴人數限制" YesNo='<%# Bind("is_showperson_fix2") %>' AutoPostBack="True" 
...
<asp:TextBox ID="txtpersonextcount_min" runat="server" Text='<%# Bind("personextcount_min") %>' Width="50px"></asp:TextBox>
                                ...
                                ~  <asp:TextBox ID="txtpersonextcount_max" runat="server" 
                                    Text='<%# Bind("personextcount_max") %>' Width="50px"></asp:TextBox>人
                             
                                <asp:RequiredFieldValidator ID="chk_txtpersonextcount_min" runat="server" ControlToValidate="txtpersonextcount_min"
                                    Display="Dynamic" ErrorMessage="攜伴人數限制必填" ValidationGroup="WizardNext" 
                                            Visible="False"></asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="chk_txtpersonextcount_min2" runat="server" 
                                    ControlToValidate="txtpersonextcount_min" ErrorMessage="攜伴人數限制必填數字" 
                                    Operator="DataTypeCheck" Type="Integer" ValidationGroup="WizardNext" 
                                ...
                                <asp:RequiredFieldValidator ID="chk_txtpersonextcount_max" runat="server" 
                                    ...
                                    ErrorMessage="攜伴人數限制必填" ValidationGroup="WizardNext" Visible="False"></asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="chk_txtpersonextcount_max2" runat="server" 
                                    ControlToValidate="txtpersonextcount_max" ErrorMessage="攜伴人數限制必填數字" 
                                    Operator="DataTypeCheck" Type="Integer" ValidationGroup="WizardNext" 
                                            Visible="False" Display="Dynamic"></asp:CompareValidator>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                        ...
                        <asp:Panel ID="PanelCustomFieldB1" runat="server" GroupingText="個人固定欄位">
                            ...
                            <asp:UpdatePanel ID="UpdatePanelB" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                     <TServerControl:TCheckBoxYN ID="chkis_showremark" runat="server" Text="備註" 
                                         YesNo='<%# Bind("is_showremark") %>' AutoPostBack="True" 
                                         oncheckedchanged="chkis_showremark_CheckedChanged" />
                            </div>
                            &nbsp; 備註顯示名稱<asp:TextBox ID="txtremark_name" runat="server" 
                        ...
                        <asp:Panel ID="PanelCustomFieldB2" runat="server" GroupingText="團隊固定欄位">
                             ...
                             <asp:UpdatePanel ID="UpdatePanelC" runat="server" UpdateMode="Conditional">
                                 <ContentTemplate>
                                    <TServerControl:TCheckBoxYN ID="chkis_showteam_fix2" runat="server" 
                                         Text="攜伴人數限制" YesNo='<%# Bind("is_showteam_fix2") %>' AutoPostBack="True" 
                             ...
                             <asp:CompareValidator ID="chk_txtteamextcount_min2" runat="server" 
                                 ControlToValidate="txtteamextcount_min" ErrorMessage="攜伴人數限制必填數字" 
                                 Operator="DataTypeCheck" Type="Integer" ValidationGroup="WizardNext" 
                                         Visible="False" Display="Dynamic"></asp:CompareValidator>
                             ...
                             <asp:CompareValidator ID="chk_txtteamextcount_max2" runat="server" 
                                 ControlToValidate="txtteamextcount_max" ErrorMessage="攜伴人數限制必填數字" 
                                 Operator="DataTypeCheck" Type="Integer" ValidationGroup="WizardNext" 
                                         Visible="False" Display="Dynamic"></asp:CompareValidator>
                                 </ContentTemplate>
                             </asp:UpdatePanel>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="chk_txtfield_name" runat="server" 
                                    ControlToValidate="txtfield_name" ErrorMessage="欄位名稱必填" 
            ...
            <asp:WizardStep runat="server" Title="Step 4">
                ...
                <asp:Panel ID="Panel_GroupLimit" runat="server" GroupingText="族群限定名單">
                    ...
                    <asp:Button ID="btnUpload_GroupLimit" runat="server" Text="上傳" 
                    ...
                    <asp:Button ID="btnExport_GroupLimit" runat="server" 
                        Text="匯出族群名單" OnClick="btnExport_GroupLimit_Click" />
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbtnDel_GroupLimit" runat="server" 
                                                onclick="lbtnDel_GroupLimit_Click" onclientclick="return confirm('確定要刪除嗎?');">刪除</asp:LinkButton>
                                        </ItemTemplate>
            ...
            <asp:WizardStep runat="server" Title="Step 5">
                注意事項<asp:RequiredFieldValidator ID="chk_txtnotice" runat="server" 
                    ControlToValidate="txtnotice" ErrorMessage="注意事項必填" 
                    ValidationGroup="WizardNext">*</asp:RequiredFieldValidator>
                <br />
