...
public partial class WebForm_ManageActivity_ActivityEdit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                //新增時ActivityType來自QueryString            
                if (Request["ActivityType"] == null || (Request["ActivityType"].ToString() != "1" && Request["ActivityType"].ToString() != "2"))
                {
                    Page.Visible = false;
                    return;
                }
            ...
            //若用ActivityID沒辦法撈到資料，表示ActivityID亂填
            if (myActivatyVO.activity_type.Trim() == "")
            {
                Page.Visible = false;
                return;
            }
            ...
            {
                //編輯時ActivityType來自資料庫
                ActivityType = myActivatyVO.activity_type;

                //檢視模式:活動已結束
                if (myActivatyVO.activity_enddate <= DateTime.Now)
                {
    ...
    protected void Wizard1_FinishButtonClick(object sender, WizardNavigationEventArgs e)
    {
        ...
        myActivatyVO.is_showfile = ((CheckBox)FormView1.FindControl("chkis_showfile")).Checked == true ? "1" : "0";
        myActivatyVO.is_showprogress = ((CheckBox)FormView1.FindControl("chkis_showprogres")).Checked == true ? "1" : "0";

        
                    myActivatyVO.is_showperson_fix1 = ((CheckBox)FormView2.FindControl("chkis_showperson_fix1")).Checked == true ? "1" : "0";
            myActivatyVO.is_showperson_fix2 = ((CheckBox)FormView2.FindControl("chkis_showperson_fix2")).Checked == true ? "1" : "0";
        ...
        if (ActivityType == "1")
        {
            ...
            myActivatyVO.is_showidno = ((CheckBox)FormView2.FindControl("chkis_showidno")).Checked == true ? "1" : "0";
            myActivatyVO.is_showremark = ((CheckBox)FormView2.FindControl("chkis_showremark")).Checked == true ? "1" : "0";
            myActivatyVO.remark_name = ((TextBox)FormView2.FindControl("txtremark_name")).Text;

            myActivatyVO.is_showteam_fix1 = ((CheckBox)FormView2.FindControl("chkis_showteam_fix1")).Checked == true ? "1" : "0";
            myActivatyVO.is_showteam_fix2 = ((CheckBox)FormView2.FindControl("chkis_showteam_fix2")).Checked == true ? "1" : "0";
...
public partial class WebForm_ManageActivity_ActivityEdit
{
    ...
    public string ActivityType
    {
        get
        {
            return (ViewState["ActivityType"] == null ? "" : ViewState["ActivityType"].ToString());
        }
    ...
    public FormViewMode MyFormMode
    {
        get
        {
            return (ViewState["MyFormMode"] == null ? FormViewMode.ReadOnly : (FormViewMode)ViewState["MyFormMode"]);
        }
