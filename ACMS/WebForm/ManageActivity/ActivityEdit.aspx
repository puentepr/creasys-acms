                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                &nbsp; 備註顯示名稱<asp:TextBox ID="txtremark_name" runat="server" Text='<%# Bind("remark_name") %>'
                                                                    Width="50px"></asp:TextBox><asp:RequiredFieldValidator ID="chk_txtremark_name" runat="server" ControlToValidate="txtremark_name"
                                                                    Display="Dynamic" ErrorMessage="備註顯示名稱必填" ValidationGroup="WizardNext" Visible="False"></asp:RequiredFieldValidator></td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanelC" runat="server" UpdateMode="Conditional" 
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    &nbsp;<asp:RequiredFieldValidator ID="chk_txtteamextcount_min" runat="server" ControlToValidate="txtteamextcount_min"
                                                        Display="Dynamic" ErrorMessage="最少攜伴人數限制必填" ValidationGroup="WizardNext" Visible="False"></asp:RequiredFieldValidator><asp:CompareValidator ID="chk_txtteamextcount_min2" runat="server" ControlToValidate="txtteamextcount_min"
                                                        ErrorMessage="攜伴人數限制必填數字" Operator="DataTypeCheck" Type="Integer" ValidationGroup="WizardNext"
                                                        ...
                                                        Display="Dynamic" ErrorMessage="最多攜伴人數限制必填" ValidationGroup="WizardNext" Visible="False"></asp:RequiredFieldValidator><asp:CompareValidator ID="chk_txtteamextcount_max2" runat="server" ControlToValidate="txtteamextcount_max"
                                                        ErrorMessage="攜伴人數限制必填數字" Operator="DataTypeCheck" Type="Integer" ValidationGroup="WizardNext"
                                                        Visible="False" Display="Dynamic"></asp:CompareValidator>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField ID="hiID" runat="server" EnableViewState="False" 
                                                                Value='<%# Bind("ID") %>' />
                                                        </ItemTemplate>
                                                        <HeaderTemplate>
                                                            <asp:CheckBox ID="chk1" runat="server" AutoPostBack="True" 
                                                                oncheckedchanged="chk1_CheckedChanged" Text="全選" />
                                                            <asp:LinkButton ID="lbtnDel_GroupLimit" runat="server" ForeColor="White" 
                                                                OnClick="lbtnDel_GroupLimit_Click" 
