...
<asp:Panel ID="panel1" runat="server" Height="550px" BackColor="white" BorderWidth="1" Width="900px" ScrollBars ="Auto" ><!--display: none;-->
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <HeaderTemplate>
                               ...
                               <asp:CheckBox ID="chk1" Text="全選" runat="server" AutoPostBack="True"  oncheckedchanged="chk1_CheckedChanged" />
                            </HeaderTemplate>
                        </asp:TemplateField>
                    </Columns>
