                                                            ...
                                                            <tr id="tr_person_fix2" runat="server">
                                                                ...
                                                                <td width="200" style="vertical-align :text-top" >
                                                                    ...
                                                                    (<asp:Label ID="lblAf2Start" runat="server" Text="Label"></asp:Label>~<asp:Label
                                                                        ID="lblAf2End" runat="server" Text="Label"></asp:Label>)<asp:RequiredFieldValidator
                                                                            ID="chk_txtperson_fix2" runat="server" ControlToValidate="txtperson_fix2" Display="Dynamic"
                                                                            ErrorMessage="攜伴人數限制必填" ValidationGroup="WizardNext" Text="*"></asp:RequiredFieldValidator><asp:CompareValidator
                                                                                ID="chk_txtperson_fix2_2" runat="server" ControlToValidate="txtperson_fix2" Display="Dynamic"
